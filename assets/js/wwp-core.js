...
const FEATURE_MODULES = {
  ...
  mosque:  { js:['/assets/js/features/find-a-mosque.js?v=13'],css:['/assets/css/features/find-a-mosque.css?v=5'] },
  travel:  { js:['/assets/js/features/travel-mode.js?v=5'],  css:['/assets/css/features/travel-mode.css?v=5'] },
