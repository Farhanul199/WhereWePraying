...
// There is no bulk/year pull possible here — this must run on a recurring
// (weekly, ideally more often) cron, same as sync-thm-jamaah.js, but looping
// over mosques instead of dates.
//
...
//
// Suggested ranges (348 mosques total, ~30 per visit to stay well under
// Cloudflare Worker subrequest/duration limits):
//   start=0&end=30
//   start=30&end=60
